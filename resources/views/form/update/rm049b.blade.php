...
<body style="margin:0;padding:0;">
        ...
        <div class="row" style="width:100%; margin-left: 0;">
            <table style="width: 100%">
                <tr>
                    ...
                    <td style="width: 20%;text-align:center;font-weight:bold;font-size:16px;">
                        <p>LEMBAR OBSERVASI<br>PEDIATRIC EARLY WARNING SCORE (PEWS)</p>
                    </td>
                    <td style="width: 40%; border: 1px solid;text-align:center;">
                        <table id="tabel_kop_identitas">
                            <tr>
                                <td style="width: 40%;">Nomor RM</td>
                                <td style="padding-left:10px; padding-right:10px"> :</td>
                                <td><input type="text"
                                        style="border: hidden; border-bottom: 1px dotted;  width: 80%"
                            ...
                            <tr>
                                ...
                                <td style="padding-left:10px; padding-right:10px"> :</td>
                                <td><input type="date"
                                        style="border: hidden; border-bottom: 1px dotted;  width: 50%"
                                        name="tanggal_lahir" id="tanggal_lahir"> L/P*)</td>
                            </tr>
                            <tr>
    ...
    <div class="container">
        <div class="col-md-12"
            ...
            <div>Pencatatan observasi menggunakan Pediatric Early  Warning Score (PEOWS) untuk pasien dengan Usia < 18 Tahun
            </div>
        </div>
        <div class="row" style="width:100%; margin-left: 0;">
        ...
        <div class="row" style="width:100%; margin-left: 0;">
            <table style="width: 100%">
                <tr>
                    ...
                    <td style="width:  20%;text-align:center;font-weight:bold;font-size:18px;">
                        <p>LEMBAR OBSERVASI<br>PEDIATRIC EARLY  WARNING SCORE (PEWS)</p>
                    </td>
                    <td style="width: 40%; border: 1px solid;text-align:center;">
                        <table id="tabel_kop_identitas">
    ...
    <div class="container">
        <div class="col-md-12"
            style="text-align:left;font-weight:bold;width: 100%; margin-left: 0; border:1px solid; padding:10px;">
            <div>Pencatatan observasi menggunakan Pediatric Early  Warning Score (PEWS) untuk pasien dengan Usia < 18 tahun
            </div>
        </div>
        <div class="row" style="width:100%; margin-left: 0;">
            <div class="col-xs-12 col-sm-12 col-md-12" id="custom-border-col-last">
                                ...
                                <table style="width: 100%">
                                    ...
                                    <tbody>
                                        <tr style="background:green;">
                                            ...
                                            <td style="text-align: center;">0-2 (Normal)</td>
                                            <td style="text-align: center;">Minimal setiap 4 jam sekali</td>
                                            <td>Lanjutkan observasi/monitoring secara rutin</td>
                                        </tr>
                                        <tr style="background:yellow;">
                                            <td style="text-align: center;">2</td>
                                            <td style="text-align: center;">TOTAL SCORE 3 (Rendah   )</td>
                                            <td style="text-align: center;">Minimal setiap 1-2 jam sekali</td>
                                            <td>
                                                <p>Perawat pelaksana menginformasikan kepada ketua tim/penanggung jawab
                                                    jaga ruangan tentang siapa yang melaksanakan assesmen selanjutnya. </p>
                                                <ul>
                                        ...
                                        <tr style="background:brown;">
                                            ...
                                            <td style="text-align: center;">TOTAL SCORE 4 (SEDANG)</td>
                                            <td style="text-align: center;">Peningkatan Frekuensi
                                                Obervasi/Monitoring. Setidaknya Setiap 1 Jam Sekali
                                            </td>
                                            <td>
                                                <ul>
                                                    <li>Ketua Tim(perawat) segera memberikan informasi tentang kondisi pasien kepada doketer jaga
                                                        / DPJP
                                                    </li>
                                                    <li>Dokter jaga atau DPJP melakukan asesmen sesuai komprensinya dan menentukan kondisi
                                                        pasien apakahh dalam penyakit  akut
                                                    </li>
                                                    <li>
                                                        Siapkan fasilitasi monitoring yang lebih canggih
                                                    </li>
                                        ...
                                        <tr style="background:red;">
                                            ...
                                            <td style="text-align: center;">TOTAL SCORE 5 ATAU LEBIH</td>
                                            ...
                                            <td>
                                                <ul>
                                                    ...
                                                    <li>
                                                        Stabilisasi oleh Tim Codde Blue dan pasien dirujuk ke Intermediate  Care
                                                    </li>
                                                    <li>
                                                        Untuk pasien IGD (Prioritas 3,4 dan 5), Perawat penanggungjawab segera kirim
                                                        pasien ke ruang Resusitaasi untuk penanganan Bantuan Hidup Lanjut (BHL)
                                                    </li>
                                                </ul>
                                             </td>
                                        </tr>
